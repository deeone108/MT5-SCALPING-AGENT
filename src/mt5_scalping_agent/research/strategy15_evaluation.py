"""Strategy 15 gate evaluation and serial-dependence diagnostics."""
...
def strategy15_gate_report(
    metrics: Strategy15GateMetrics,
...
def _primary_rows(
    m: Strategy15GateMetrics, g: EconomicPromotionGate
